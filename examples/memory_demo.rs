...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    simple_memory
        ...
        .await?;
    simple_memory
        .store("Tell me about Python", "Python is great for data science")
        .await?;
    simple_memory
        .store("Explain JavaScript", "JavaScript runs in browsers")
        .await?;
    ...
    let knowledge = vec![
        ...
        (
            "computer vision",
            "CV enables computers to understand visual information",
        ),
        (
    ...
    println!(
        "Current entries: {} (oldest entries were removed)",
        stats.total_entries
    );
