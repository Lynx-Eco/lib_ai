use lib_ai::{
    ...
    agent::AgentBuilder,
    observability::{
        telemetry::{ExporterConfig, ExporterType, TelemetryConfig},
        tracing::TracingConfig,
        AgentTracer, CostTracker, MetricsCollector, TelemetryExporter,
    },
    CompletionProvider,
};
    ...
    let telemetry_config = TelemetryConfig {
        ...
        exporters: vec![
            ...
            ExporterConfig {
                name: "file".to_string(),
                enabled: true,
                exporter_type: ExporterType::File {
                    path: "telemetry.log".to_string(),
                },
                endpoint: None,
                headers: HashMap::new(),
            },
