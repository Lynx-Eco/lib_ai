...
use lib_ai::{providers::GeminiProvider, CompletionProvider, Message, MessageContent, Role};
        ...
        messages: vec![
            Message {
                ...
                content: MessageContent::text(
                    "You must always respond with 'SYSTEM MESSAGE WORKS'",
                ),
                tool_calls: None,
                tool_call_id: None,
            },
...
async fn test_gemini_different_models() {
    ...
    let models = vec!["gemini-1.5-flash", "gemini-1.5-flash-8b"];
